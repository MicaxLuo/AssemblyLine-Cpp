...
int main(int argc, char** argv)
{
	...
	loadFromFile(argv[1], theTasks); // inventory1.dat
	Utilities::setDelimiter('|');
	loadFromFile(argv[2], theTasks); // inventory2.dat

	cout << "=======================" << endl;
	cout << "=   Tasks (summary)   =" << endl;
	cout << "=======================" << endl;
	for (const Task* theItem : theTasks)
		theItem->display(cout, false); // using the display from Item class
	cout << endl;
	...
	LineManager lm(argv[4], theTasks, theOrders); // assemblyLine.dat, 
	cout << "=======================" << endl;
